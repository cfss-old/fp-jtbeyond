...
We then present two graphs depicting the percentages of terms in each subcategory in all reports on the front page of the People's Daily. The first plots the trend on a monthly basis, while the second on a more detailed, daily basis *(Note: in both plots the blue and red dashed lines denote the periods of social movements in 1986 and 1989 respectively)*: 
